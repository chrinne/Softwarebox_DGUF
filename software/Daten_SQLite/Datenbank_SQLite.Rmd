...
Die Liste wird derart auf die Befunde und deren abgefragten Attribute eingeschränkt, die zugleich auch Funde erbracht haben. Im vorliegenden Fall ausschließlich die Grube Befund 1005. Weiteren JOIN-Anweisungen für andere Tabellen (c) sind möglich, sowohl mit einem erneuten Bezug auf die erste Tabelle (a) als auch auf bereits verknüpfte Tabelle (b).
...
```{sql INNER JOIN Abfrage für Fundkontexte aus der Tabeklle und derAbfrage, connection=db01}
