...
Für JOIN gibt es mehrere Möglichkeiten ([Operatoren](https://sqlite.org/syntax/join-operator.html)) von denen nachfolgend nur *INNER JOIN* und *LEFT JOIN* vorgestellt werden (dazu noch Varianten nach SQL-Version).

### INNER JOIN

Dieser Befehl liefert ausschließlich die Datensätze, bei denen identische Werte für die ausgewählten Attribute beider Tabellen identisch sind.
