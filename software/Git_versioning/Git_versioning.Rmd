...
Im folgenden wird nur ein Projekt auf den lokalen Rechner übertragen (clone), eine Änderung kommentiert (*commit*) und hochgeladen (*push*).

Sofern nach dem Start kein Fenster zum Öffnen oder Klonen von Repositorien angezeigt wird: Start > Tepository klonen ... .  In dem neuen Fenster "Klonen" ergänzen Sie folgendes:
